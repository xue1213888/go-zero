...
func init() {
	...
	protocCmdFlags.StringSliceVar(&cli.VarStringSliceGoGoFasterOut, "gogofaster_out")
	protocCmdFlags.StringSliceVar(&cli.VarStringSliceGoGoFasterOpt, "gogofaster_opt")
	...
	protocCmdFlags.MarkHidden("gogofaster_out")
	protocCmdFlags.MarkHidden("gogofaster_opt")
